...
public class MySampleUser implements User, Serializable {
    ...
    private transient MySampleStore keyValStore;
    private String keyValStoreName;


    public MySampleUser(String name, String org, MySampleStore fs) {
        this.name = name;
     ...
     */
    public MySampleUser restoreState() {
        String memberStr = keyValStore.getValue(keyValStoreName);
        if (null != memberStr) {
            ...
            try {
                ...
                MySampleUser state = (MySampleUser) ois.readObject();
                if (state != null) {
